        ...
        <div className="row">
          <div className="col  ">
            ...
            <p className="para" style={{ marginTop: "40px" }}>Organic Food is grown without the usage of synthetic chemicals and preservatives
              ...
              We are one ideal producers of organic foods and fruits right now in INDIA.
            </p>
            <button type="button" className="btn btn-danger">Find Us</button>
          </div>
          <div className="col ">
            <img src={img4} class="col-md-6 float-md-end mb-3 mx-md-3" alt="..." style={{ marginTop: "60px", borderRadius: "50px" }} />
            <img src={img2} class="col-md-6 float-md-end mb-3 mx-md-3" alt="..." style={{ marginTop: "20px", borderRadius: "50px" }} />


            <div className="row" >
              <img src={img3} class="col-md-6 float-md-end mb-3 mx-md-3 image-three" alt="..." style={{ marginTop: "80px", height: "370px", width: "800px", borderRadius: "50px" }} />
6
        ...
        <div className="row">
          ...
          <div className="col ">
            ...
            <div className="row  order-4" >
              <img src={img5} class="col-md-6 float-md-end mb-3 ms-md-3" alt="This image is not here " style={{ marginTop: "40px", height: "370px", width: "550px", borderRadius: "100px" }} />
